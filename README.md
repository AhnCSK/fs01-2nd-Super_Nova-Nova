...
#### 1.1. 스마트팜 환경 데이터 정의
    - 온도, 습도, 조도 등 센서 데이터 항목 정의
    - 액추에이터 제어 데이터 정의 (히터, 팬, 조명)

#### 1.2. 사용자 및 마켓 기능 요구사항 분석
    - 사용자 권한 정의 (관리자 / 일반 사용자)
    - 마켓 기능 요구사항 도출 (상품, 주문, 재고)
...
#### 3.2. 웹 대시보드 및 마켓 화면 구현
    - 환경 데이터 시각화 대시보드 구현
    - 마켓 상품 및 주문 화면 구현

#### 3.3. 액추에이터 제어 및 통합 테스트
